...
to setup
  ...
  set quantity-buyers 0
  set quantity-sellers 0
...
to go
  ...
  set quantity-buyers count buyers with [willingness-to-pay >= equilibrium-price]
  set quantity-sellers count sellers with [cost-to-produce <= equilibrium-price]
